...
const defaultMenuItems = [
  ...
  { name: 'Переводы', path: '/transfer', icon: 'transfer' },
...
const getItemIcon = (item) => {
  ...
  if (item.path === '/transfer') {
    return `<svg width="22" height="22" viewBox="0 0 24 24" fill="none">
      <path d="M21 12V7H5C3.89543 7 3 6.10457 3 5V19C3 20.1046 3.89543 21 5 21H19C20.1046 21 21 20.1046 21 19V17" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M3 5C3 3.89543 3.89543 3 5 3H18" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
